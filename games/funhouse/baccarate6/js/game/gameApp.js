...
import {BCTGameView} from "./views/BCTGameView";
import { BCT_GAMEVIEW_CONFIG } from './config/views/BCTGameViewConfig'
...
export class GameApp extends Application {
    ...
    createGameView () {
        ...
        let gameView = super.createViewComponent(new BCTGameView(BCT_GAMEVIEW_CONFIG), "gameview");
