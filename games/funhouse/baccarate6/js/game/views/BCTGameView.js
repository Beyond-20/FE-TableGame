...
export class BCTGameView extends TGGameView {
    ...
    getCountText (data) {
        return (data.easySixCreateGame.roundCount + " / " + data.easySixCreateGame.totalCount);
    }
    onBCTSocketMessage (data) {
        ...
        if (msg.indexOf("easySix") > -1) {
            if (msg != "easySixBaccaratBet") {
            ...
            switch (msg) {
                ...
                case "easySixStartGame" :
                    ...
                    CoreLib.EventHandler.dispatchEvent("PLAY_NOMORE_BETS_VOICE");
                    break;
                case "easySixGameResult" :
                    if (data.easySixGameResult.player_id == slotModel.getPlayerId()) {
                        CoreLib.Model.GameConfig.bctWinning += data.easySixGameResult.result.totalWin;
                        ...
                        this.cardsAreaComp.storeGameResult(data.easySixGameResult);
                    }
                    break;
                case "easySixRunGame" :
                    this.panelComp.setState(false);
                    ...
                    this.chipsPanel.setCompEnabled(false);
                    this.dealResult = {};
                    this.dealResult.result = data.easySixRunGame;
                    this.panelComp.setState(false);
                    this.cardsAreaComp.dealCards(this.dealResult.result);
                    break;
                case "easySixBaccaratBet" :
                    this.handleBetPlacement(data.easySixBaccaratBet);
                    break;
                default :
                    break;
            }
