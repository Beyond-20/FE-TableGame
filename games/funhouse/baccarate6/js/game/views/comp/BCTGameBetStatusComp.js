...
export class BCTGameBetStatusComp extends LibContainer {
    ...
    updateBetData (arr, perc) {
        ...
        if (this.configData.percPosition != undefined && this.configData.percPosition == "right") {
            CoreLib.UIUtil.setPosition(this.totalBetText, this.percComp.x - this.totalBetText.width * 1.1, this.totalPlayerText.y + this.totalPlayerText.height * 1.2);
        } else {
            CoreLib.UIUtil.setPosition(this.totalBetText, this.percComp.x + this.percComp.width * 1.1, this.totalPlayerText.y + this.totalPlayerText.height * 1.2);
        }
