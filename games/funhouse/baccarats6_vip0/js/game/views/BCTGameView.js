...
export class BCTGameView extends TGGameView {
    ...
    getCountText (data) {
        return (data.vip0_createGame.roundCount + " / " + data.vip0_createGame.totalCount);
    }
    onBCTSocketMessage (data) {
        ...
        if (msg.indexOf("vip0_") > -1) {
            if (msg != "vip0_BaccaratBet") {
                let arr = msg.split("_");
            ...
            switch (msg) {
                ...
                case "vip0_startGame" :
                    ...
                    CoreLib.EventHandler.dispatchEvent("PLAY_NOMORE_BETS_VOICE");
                    break;
                case "vip0_gameResult" :
                    if (data.vip0_gameResult.player_id == slotModel.getPlayerId()) {
                        CoreLib.Model.GameConfig.bctWinning += data.vip0_gameResult.result.totalWin;
                        ...
                        this.cardsAreaComp.storeGameResult(data.vip0_gameResult);
                    }
                    break;
                case "vip0_runGame" :
                    this.panelComp.setState(false);
                    ...
                    this.chipsPanel.setCompEnabled(false);
                    this.dealResult = {};
                    this.dealResult.result = data.vip0_runGame;
                    this.panelComp.setState(false);
                    this.cardsAreaComp.dealCards(this.dealResult.result);
                    break;
                case "vip0_BaccaratBet" :
                    this.handleBetPlacement(data.vip0_BaccaratBet);
                    break;
                default :
                    break;
            }
