...
export class BCTGameView extends TGGameView {
    ...
    getCountText (data) {
        return (data.vip2_createGame.roundCount + " / " + data.vip2_createGame.totalCount);
    }
    onBCTSocketMessage (data) {
        ...
        if (msg.indexOf("vip2_") > -1) {
            if (msg != "vip2_BaccaratBet") {
                let arr = msg.split("_");
            ...
            switch (msg) {
                ...
                case "vip2_startGame" :
                    ...
                    CoreLib.EventHandler.dispatchEvent("PLAY_NOMORE_BETS_VOICE");
                    break;
                case "vip2_gameResult" :
                    if (data.vip2_gameResult.player_id == slotModel.getPlayerId()) {
                        CoreLib.Model.GameConfig.bctWinning += data.vip2_gameResult.result.totalWin;
                        ...
                        this.cardsAreaComp.storeGameResult(data.vip2_gameResult);
                    }
                    break;
                case "vip2_runGame" :
                    this.panelComp.setState(false);
                    ...
                    this.chipsPanel.setCompEnabled(false);
                    this.dealResult = {};
                    this.dealResult.result = data.vip2_runGame;
                    this.panelComp.setState(false);
                    this.cardsAreaComp.dealCards(this.dealResult.result);
                    break;
                case "vip2_BaccaratBet" :
                    this.handleBetPlacement(data.vip2_BaccaratBet);
                    break;
                default :
                    break;
            }
