...
let historyData = {};
historyData = [
    {"winner":"dealer","playerPair":false,"dealerPair":true,"super6":false},
    {"winner":"dealer","playerPair":false,"dealerPair":false,"super6":false},
    {"winner":"tie","playerPair":true,"dealerPair":true,"super6":false},
    {"winner":"dealer","playerPair":false,"dealerPair":false,"super6":false},
    {"winner":"dealer","playerPair":false,"dealerPair":false,"super6":false},
    {"winner":"dealer","playerPair":false,"dealerPair":false,"super6":true},
    {"winner":"dealer","playerPair":false,"dealerPair":false,"super6":false},
    {"winner":"dealer","playerPair":false,"dealerPair":false,"super6":false},
    {"winner":"dealer","playerPair":false,"dealerPair":false,"super6":false},
    {"winner":"dealer","playerPair":true,"dealerPair":false,"super6":false},
    {"winner":"tie","playerPair":false,"dealerPair":true,"super6":false},
    {"winner":"dealer","playerPair":false,"dealerPair":true,"super6":false},
    {"winner":"dealer","playerPair":false,"dealerPair":true,"super6":false},
    {"winner":"player","playerPair":false,"dealerPair":true,"super6":false},
...
export class BCTRoadmapComp extends LibView {
    ...
    onRoadmapData(){
        ...
        for (let k = 0; k < toshowResult; k++) {
            ...
            if (k == 0) {
                arr[index].push({ result: this.getWinner(result[k]), tie: false, super6: result[k].super6 });
                easyarr[index].push({ result: this.getWinner(result[k]), tie: false, super6: result[k].super6 });
            } else if (k == 1) {
                if (this.getWinner(result[k]) == this.getWinner(result[k - 1]) || (this.getWinner(result[k - 1]) == "tie")) {
                    if (this.getWinner(result[k]) != "tie") {
                        ...
                        if (arr[index].length >= 1) {
                            ...
                            arr[index][arr[index].length - 1].super6 = result[k].super6;
                            if (result[k - 1].super6) {
                                arr[index][arr[index].length - 1].tieS6 = true;
                            }
                        }
