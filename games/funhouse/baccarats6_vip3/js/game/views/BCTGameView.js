...
export class BCTGameView extends TGGameView {
    ...
    getCountText (data) {
        return (data.vip3_createGame.roundCount + " / " + data.vip3_createGame.totalCount);
    }
    onBCTSocketMessage (data) {
        ...
        if (msg.indexOf("vip3_") > -1) {
            if (msg != "vip3_BaccaratBet") {
                let arr = msg.split("_");
            ...
            switch (msg) {
                ...
                case "vip3_startGame" :
                    ...
                    CoreLib.EventHandler.dispatchEvent("PLAY_NOMORE_BETS_VOICE");
                    break;
                case "vip3_gameResult" :
                    if (data.vip3_gameResult.player_id == slotModel.getPlayerId()) {
                        CoreLib.Model.GameConfig.bctWinning += data.vip3_gameResult.result.totalWin;
                        ...
                        this.cardsAreaComp.storeGameResult(data.vip3_gameResult);
                    }
                    break;
                case "vip3_runGame" :
                    this.panelComp.setState(false);
                    ...
                    this.chipsPanel.setCompEnabled(false);
                    this.dealResult = {};
                    this.dealResult.result = data.vip3_runGame;
                    this.panelComp.setState(false);
                    this.cardsAreaComp.dealCards(this.dealResult.result);
                    break;
                case "vip3_BaccaratBet" :
                    this.handleBetPlacement(data.vip3_BaccaratBet);
                    break;
                default :
                    break;
            }
